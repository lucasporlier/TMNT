				...
				<header id="header">
					...
					<nav id="nav">
						<ul>
							...
							<li><a href="connexion.php" class="button special">Se connecter</a></li>
						</ul>
					</nav>
				</header>
			...
			<!-- Footer -->
				<footer id="footer">
					<ul class="icons">
						...
						<li><a href="linkedin.com/company/epsi-paris" class="icon alt fa-linkedin"><span class="label">LinkedIn</span></a></li>
